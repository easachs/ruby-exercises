RSpec.describe 'all pattern' do
  ...
  it 'test 5' do
    ...
    all_busy = true
    statuses.each do |s|
      all_busy = false unless s.to_s == 'busy'
    end
  ...
  it 'test 6' do
    ...
    friend_status.each do |k,v|
      all_busy = false unless v.to_s == 'busy'
    end
  ...
  it 'test 7' do
    ...
    zip_codes.each do |z|
      all_five_digits = false unless z.to_s.length == 5
    end
  ...
  it 'test 8' do
    ...
    zip_codes.each do |k,v|
      all_five_digits = false unless v.to_s.length == 5
    end
  ...
  it 'test 9' do
    ...
    all_caps = true
    snacks.each do |s|
      all_caps = false unless s.match?(/[:upper:]/)
    end
  ...
  it 'test 10' do
    ...
    all_caps = true
    snacks.each do |k,v|
      all_caps = false unless v.match?(/[:upper:]/)
    end
