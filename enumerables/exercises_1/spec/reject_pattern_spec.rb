RSpec.describe 'reject pattern' do
  ...
  it 'removes words ending in e' do
    ...
    selected = []
    words.each do |word|
      selected << word unless word.slice(-1) == 'e'
    end
  ...
  it 'removes words ending in ing' do
    ...
    selected = []
    words.each do |word|
      selected << word unless word.slice(-3..-1) == 'ing'
    end
  ...
  it 'removes animals starting with vowels' do
    ...
    remaining = []
    animals.each do |animal|
      remaining << animal unless animal.slice(0).match?(/[aeiou]/)
    end
  ...
  it 'removes upcased words' do
    ...
    remaining = []
    words.each do |word|
      remaining << word if word.match?(/[^A-Z]/)
    end
